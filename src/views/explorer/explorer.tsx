                    ...
                    <Header>
                        <Navbar className={"sub-menu"}>
                            ...
                            <Nav pullRight>
                                ...
                                <Nav.Item eventKey="query-history">Query History</Nav.Item>
                                <Nav.Item eventKey="display-settings" icon={<PcIcon/>}>Display Settings</Nav.Item>
                                {/*<Nav.Item eventKey="events">Events</Nav.Item>*/}
