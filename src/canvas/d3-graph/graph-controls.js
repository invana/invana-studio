...
export default class GraphControls {

    hideVertexLabels() {
        document.querySelectorAll("g.node text").hide();
    }

    showVertexLabels() {
        document.querySelectorAll("g.node text").show();
    }

    hideEdgeLabels() {
        document.querySelectorAll(".edgelabel").hide();
    }

    showEdgeLabels() {
        document.querySelectorAll(".edgelabel").show();
    }
